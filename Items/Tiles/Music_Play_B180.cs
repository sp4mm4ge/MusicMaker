...
{
	public class Music_Play_B180 : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Gold Bass Music Player");
            drop = mod.ItemType("Music_Play_B180");
