...
{
	public class Note_DS_Up : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("DS Note - Octave +1");
		...
		public override void RightClick(int i, int j) 	{
			...
			Main.tile[x,y].type = (ushort)mod.TileType("Note_DS_Down");
			Main.tile[x+1,y].type = (ushort)mod.TileType("Note_DS_Down");
			Main.tile[x,y+1].type = (ushort)mod.TileType("Note_DS_Down");
			Main.tile[x+1,y+1].type = (ushort)mod.TileType("Note_DS_Down");
