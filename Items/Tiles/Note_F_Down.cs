...
{
	public class Note_F_Down : ModTile
	{
		...
		public override void RightClick(int i, int j) 	{
			...
			Main.tile[x,y].type = (ushort)mod.TileType("Note_F");
			Main.tile[x+1,y].type = (ushort)mod.TileType("Note_F");
			Main.tile[x,y+1].type = (ushort)mod.TileType("Note_F");
			Main.tile[x+1,y+1].type = (ushort)mod.TileType("Note_F");
